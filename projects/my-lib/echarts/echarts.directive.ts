import {
    Directive, ElementRef, Input, Output, HostListener, EventEmitter,
    OnChanges, OnDestroy, SimpleChanges, NgZone, DoCheck, AfterViewInit
} from '@angular/core';
import { ChangeFilter } from './echarts';
import { Subject, Subscription } from 'rxjs';
import { debounceTime } from 'rxjs/operators';
import { init, ECharts, EChartOption } from 'echarts';
import { EChartEvents, EChartEventsAll } from './echarts.enum';

@Directive({
    // tslint:disable-next-line:directive-selector
    selector: 'sim-echarts, [sim-echarts]'
})
export class EchartsDirective implements OnChanges, OnDestroy, DoCheck, AfterViewInit {
